    ...
    <div class="max-w-4xl mx-auto">
        <div class="p-8 bg-white rounded-lg shadow-xl">
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-gray-600">Update data kehadiran karyawan</p>
            </div>
            ...
            <form action="{{ route('attendance.update', $attendance->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="nama_lengkap" readonly
                        value="{{ old('nama_lengkap', $attendance->employee->nama_lengkap) }}"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status_absensi" value="hadir" 
                                {{ old('status_absensi', $attendance->status_absensi) == 'hadir' ? 'checked' : '' }}
                                class="sr-only peer">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status_absensi" value="izin"
                                {{ old('status_absensi', $attendance->status_absensi) == 'izin' ? 'checked' : '' }}
                                class="sr-only peer">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status_absensi" value="sakit"
                                {{ old('status_absensi', $attendance->status_absensi) == 'sakit' ? 'checked' : '' }}
                                class="sr-only peer">
                        ...
                        <label class="relative cursor-pointer">
                            <input type="radio" name="status_absensi" value="alpha"
                                {{ old('status_absensi', $attendance->status_absensi) == 'alpha' ? 'checked' : '' }}
                                class="sr-only peer">
