...
<body>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="p-8 bg-white rounded-lg shadow-xl">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-gray-800">Tambah Jabatan Baru</h1>
                <p class="mt-1 text-gray-600">Isi form berikut untuk menambahkan jabatan</p>
            </div>
            ...
            <form action="{{ route('position.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Masukkan nama jabatan/posisi</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Masukkan gaji pokok dalam Rupiah (angka saja, tanpa titik/koma)</p>
                </div>
                ...
                <div class="p-4 border-2 border-purple-200 rounded-lg bg-purple-50">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-xl font-bold text-purple-600" id="preview-gaji">Rp 0</p>
                        </div>
                    </div>
                </div>
